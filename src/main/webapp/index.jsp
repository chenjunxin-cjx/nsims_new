			...
			<div class="sidebar">
				<div class="scrollbar-inner sidebar-wrapper">
					...
					<ul class="nav">
						...
						<li class="nav-item">
							<a href="WEB-INF/view/components.html">
						...
						<li class="nav-item">
							<a href="WEB-INF/view/forms.html">
						...
						<li class="nav-item">
							<a href="WEB-INF/view/tables.html">
								<i class="la la-th"></i>
								<p>Tables</p>
						...
						<li class="nav-item">
							<a href="WEB-INF/view/notifications.html">
								<i class="la la-bell"></i>
								<p>Notifications</p>
						...
						<li class="nav-item">
							<a href="WEB-INF/view/typography.html">
						...
						<li class="nav-item">
							<a href="WEB-INF/view/icons.html">
				...
				<footer class="footer">
					<div class="container-fluid">
						...
						<div class="copyright ml-auto">
							2018, made with <i class="la la-heart heart text-danger"></i> by <a href="#">ThemeKita</a></div>
					</div>
				</footer>
			</div>
		</div>
